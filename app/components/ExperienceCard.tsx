...
const ExperienceCard = ({
  ...
  return (
    ...
    <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] bg-[#292929] pl-8 py-6 md:py-10 hover:opacity-100 opacity-40  transition-opacity duration-200 overflow-hidden embla__slide">
      {/* <motion.img
        initial={{
          y: -100,
          opacity: 0,
